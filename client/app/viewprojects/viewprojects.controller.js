...
angular.module('testApp')
    .controller('ViewprojectsCtrl', ['$scope', '$http', 'projects', 'messages', '$location', '$state', 'Modal', 'status', 'performance', 'dropdowns',
            ...
            $scope.showAddProjectList = Modal.confirm.addProjectList(function(list) { // callback when modal is confirmed
                ...
                projects.insertIntoList(updateList).success(function(response) {
                    ...
                    if (response.response === 'Exists') {
                        ...
                        title = 'Warning';
                        type = 'warning';
                        url = 'viewprojects?listId=' + $scope.listId;
